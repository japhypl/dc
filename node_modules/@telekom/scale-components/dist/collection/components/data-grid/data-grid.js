...
export class DataGrid {
  ...
  renderSettingsMenu() {
    ...
    return (h("scale-menu-flyout", { class: `${name}__settings-menu` },
      h("scale-button", { slot: "trigger", variant: "secondary", "icon-only": true, "data-sortable": this.isSortable },
        h("scale-icon-service-settings", { accessibilityTitle: ((_a = this.localization) === null || _a === void 0 ? void 0 : _a.tableOptions) || 'Table options' })),
      h("scale-menu-flyout-list", null,
        this.isSortable && (h("scale-menu-flyout-item", { id: "sortBy", onClick: this.handleMenuListClick },
          ...
          ((_b = this.localization) === null || _b === void 0 ? void 0 : _b.sortBy) || 'Sort By',
        ...
        h("scale-menu-flyout-item", { id: "toggleVisibility", onClick: this.handleMenuListClick },
          ...
          ((_c = this.localization) === null || _c === void 0 ? void 0 : _c.toggle) || 'Toggle Visibility',
        ...
        this.selectable && (h("scale-menu-flyout-item", { "onScale-select": () => {
          ...
          ((_d = this.localization) === null || _d === void 0 ? void 0 : _d.select) || 'Select / Deselect All')),
        h("slot", { name: "menu" }))));
  }
  renderTable() {
    if (this.needsAutoWidthParse) {
    ...
    return (h("div", { ref: (el) => (this.elScrollContainer = el), class: `${name}__scroll-container`, part: "scrollable", style: { height: this.height || 'auto' }, onScroll: () => this.onTableScroll() },
  ...
  renderTableHead() {
    ...
    return (h("thead", { ref: (el) => (this.elTableHead = el), class: `thead ${this.hideHeader ? 'sr-only' : ''}` },
      h("tr", { class: `thead__row` },
        ...
        this.selectable && this.renderTableHeadSelectableCell(), (_a = this.fields) === null || _a === void 0 ? void 0 :
        _a.map(({ type, label = '', 
          ...
          return (h("th", Object.assign({ title: sortable ? this.sortableColumnTitle : undefined }, props, (sortable
            ...
            h("div", { class: `thead__title` },
              h("span", { class: `thead__text` },
                sortable && (h("scale-icon-content-sort-indicator-up", { size: 16, class: `thead__arrow-top` })),
                sortable && (h("scale-icon-content-sort-indicator-down", { size: 16, class: `thead__arrow-bottom` })),
                label)),
  ...
  renderTableHeadSelectableCell() {
    ...
    return (h("th", { class: `thead__cell thead__cell--selection`, style: style, title: "Select" },
      h("scale-checkbox", { ref: (el) => (this.elToggleSelectAll = el), onScaleChange: () => this.toggleSelectAll(), hideLabel: true, ariaLabelCheckbox: "Select" })));
  }
  renderTableBody() {
  ...
  render() {
    ...
    return (h(Host, { style: {
      ...
      h("div", { class: this.getCssClassMap() },
        h("div", { class: `${name}__title-block`, part: "title" },
  ...
  static get properties() { return {
    ...
    "sortableColumnTitle": {
      ...
      "docs": {
        "tags": [],
        "text": "(optional) Title for sortable columns"
      },
      "attribute": "sortable-column-title",
      "reflect": false,
      "defaultValue": "'Activate to sort column'"
    },
    "localization": {
      "type": "unknown",
      "mutable": false,
      "complexType": {
        "original": "{\n    sortBy: string;\n    toggle: string;\n    select: string;\n    tableOptions: string;\n    expand?: string;\n    collapse?: string;\n  }",
        "resolved": "{ sortBy: string; toggle: string; select: string; tableOptions: string; expand?: string; collapse?: string; }",
        "references": {}
      },
      "required": false,
      "optional": true,
      "docs": {
        "tags": [],
        "text": "(optional) set localization for sort, toggle, select/deselect, table options, expand/collapse (html cell)\nDefault is English."
      }
    }
  }; }
  ...
  static get events() { return [{
      ...
      "docs": {
        "tags": [],
        "text": "Event triggered every time the selection list updates"
      },
      "complexType": {
        "original": "any[]",
        "resolved": "any[]",
