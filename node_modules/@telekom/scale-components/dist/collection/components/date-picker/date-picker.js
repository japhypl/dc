...
export class DatePicker {
  ...
  render() {
    return (h(Host, null,
      ...
      h("div", { class: classNames('scale-date-picker', this.status && `scale-date-picker--status-${this.status}`, this.invalid && `scale-date-picker--status-error`, this.hasFocus && 'scale-date-picker--focus', this.disabled && 'scale-date-picker--disabled', this.hasValue && 'animated', this.helperText && 'has-helper-text') },
  ...
  static get properties() { return {
    ...
    "placeholder": {
      ...
      "docs": {
        "tags": [],
        "text": "(optional) Input place holder"
      },
