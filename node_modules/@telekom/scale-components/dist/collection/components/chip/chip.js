...
export class Chip {
  ...
  render() {
    return (h(Host, null,
      ...
      h("span", { role: this.ariaRoleTitle, "aria-checked": this.selected.toString(), tabindex: this.disabled ? '-1' : '0', part: this.getBasePartMap(), class: this.getCssClassMap(), onClick: this.handleClick, onKeyDown: this.handleKeyDown },
