...
export class DropdownSelect {
      ...
      h("div", { part: this.getBasePartMap() },
        h("div", { part: "combobox-container" },
          ...
          h("div", Object.assign({ ref: (el) => (this.comboEl = el), "aria-controls": `${this.comboboxId}-listbox`, "aria-expanded": this.open ? 'true' : 'false', "aria-haspopup": "listbox", "aria-labelledby": `${this.comboboxId}-label`, "aria-details": this.ariaDetailsId, id: this.comboboxId, part: "combobox", role: "combobox", tabindex: this.disabled ? '-1' : '0', onBlur: this.handleBlur, onFocus: this.handleFocus, onClick: this.handleClick, onKeyDown: this.handleKeyDown }, (this.open
            ...
            : {}), ariaDescribedByAttr, (this.invalid ? { 'aria-invalid': 'true' } : {})),
            h("span", { part: "combobox-value" }, hasEmptyValueElement ? '' : ValueElement)),
          h("div", { part: "listbox-pad", ref: (el) => (this.listboxPadEl = el) },
            h("div", { ref: (el) => (this.scrollContainer = el), part: "listbox-scroll-container", onMouseDown: (e) => {
                e.preventDefault();
              } },
          ...
          this.allowClear && this.value ? (h("scale-icon-action-close", { "accessibility-title": "close", part: "clear", onClick: this.handleClearClick })) : (h("div", { part: "icon" }, this.open ? (h("scale-icon-navigation-collapse-up", { decorative: true, size: DEFAULT_ICON_SIZE })) : (h("scale-icon-navigation-collapse-down", { decorative: true, size: DEFAULT_ICON_SIZE }))))),
  ...
  static get events() { return [{
      ...
      "docs": {
        "tags": [],
        "text": "(optional) clear button inside the dropdown, that clears all iputs and resets the dropdown"
      },
      "complexType": {
        "original": "void",
        "resolved": "void",
