...
const Badge = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("span", { part: "base", "aria-label": this.count ? this.getAriaLabel() : this.label }, index.h("slot", null), index.h("slot", { name: "dot" }), index.h("span", { "aria-hidden": "true", part: index$1.classnames(`circle`, this.count ? `has-count` : 'no-count') }, !this.count ? '' : this.formatter.format(this.count)), index.h("span", { "aria-hidden": "true", id: "raw-count", part: "visually-hidden" }, this.count)), index.h("span", { id: "label", part: index$1.classnames('label', this.labelVisuallyHidden && 'visually-hidden'), "aria-hidden": "true" }, this.label)));
  }
