...
const Segment = class {
  constructor(hostRef) {
    ...
    this.scaleClick = index.createEvent(this, "scale-click", 7);
    this.scaleClickLegacy = index.createEvent(this, "scaleClick", 7);
  ...
  selectionChanged() {
    utils.emitEvent(this, 'scaleClick', {
      id: this.segmentId,
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("button", { ref: (el) => (this.focusableElement = el), class: this.getCssClassMap(), id: this.segmentId, onClick: this.handleClick, disabled: this.disabled, type: "button", style: { width: this.width }, "aria-label": this.ariaLabelSegment, "aria-pressed": this.selected, part: this.getBasePartMap(), "aria-description": this.getAriaDescriptionTranslation() }, index.h("div", { class: "segment--mask" }, !this.iconOnly && (index.h("div", { class: "success-icon-container" }, index.h("scale-icon-action-checkmark", { size: this.size === 'small'
        ? 14
        : this.size === 'medium'
          ? 16
          : 20, class: "scale-icon-action-checkmark", "aria-hidden": "true", selected: true }))), index.h("div", { class: "icon-container" }, index.h("slot", { name: "segment-icon" })), index.h("slot", null)))));
  }
  getBasePartMap() {
  ...
  getCssOrBasePartMap(mode) {
    ...
    return index$1.classnames('segment', this.size && `${prefix}${this.size}`, this.selected && `${prefix}selected`, this.disabled && `${prefix}disabled`, this.adjacentSiblings &&
