...
const index$2 = require('./index-53f5a5fc.js');
const utils = require('./utils-e9c3b953.js');
const index$1 = require('./index-f625ec9e.js');
...
const CheckboxCell = {
  ...
  render: ({ field, content, component, rowIndex, columnIndex }) => {
    ...
    switch (style) {
      case 'switch':
        return index.h("scale-switch", Object.assign({ size: "small" }, props));
      default:
        // 'checkbox'
...
const DateCell = {
  ...
  render: ({ content, isAutoWidthCheck }) => {
    let value = content !== null && content !== void 0 ? content : '';
...
const EmailCell = {
  ...
  render: ({ content }) => {
    ...
    return index.h("scale-link", { href: content }, emailNoProtocol);
  },
};
    ...
    switch (style) {
      case 'bar':
        return (index.h("div", { class: `tbody__bar-cell` },
          index.h("scale-progress-bar", { class: "data-grid-progress-bar", "aria-hidden": "true", percentage: progress, 
            // showStatus={true}
            mute: true }),
          index.h("p", { class: `scl-body` }, content)));
      default:
        // progress
        return (index.h("scale-progress-bar", { class: "data-grid-progress-bar", percentage: progress, showStatus: true, mute: true }));
    }
  },
};
...
const LinkCell = {
  ...
  render: ({ content }) => {
    if (typeof content === 'string') {
      ...
      return index.h("scale-link", Object.assign({}, props), text);
    }
  },
};
...
const HTMLCell = {
  ...
  render: ({ content, component, localization }) => {
    const getAriaLabel = () => {
      if ((localization === null || localization === void 0 ? void 0 : localization.expand) && (localization === null || localization === void 0 ? void 0 : localization.collapse)) {
        return content.isExpanded
          ? localization === null || localization === void 0 ? void 0 : localization.collapse
          : localization === null || localization === void 0 ? void 0 : localization.expand;
      }
      return `Activate to ${content.isExpanded ? 'collapse' : 'expand'} content`;
    };
    return (content && (index.h("scale-button", { variant: "secondary", size: "small", "icon-only": true, "inner-aria-label": getAriaLabel(), onClick: () => {
...
const TagsCell = {
  ...
  render: ({ content }) => {
    ...
    return (index.h("ul", { class: `tbody__tag-list` }, tags.map((tag) => (index.h("li", null,
      index.h("scale-tag", { size: tag.size || 'small', type: tag.type || 'strong', color: tag.color || 'standard' }, tag.content))))));
  },
};
...
const TextCell = {
  ...
  render: ({ field, content, component, rowIndex, columnIndex, isAutoWidthCheck, }) => {
    const { variant = 'body', editable = false, iconPrefix, iconSuffix, label, textFieldProps = {}, } = field;
    // Input component doesn't expand with content, so need to return a fake element that simulates width
    if (isAutoWidthCheck && editable) {
      return (index.h("p", { class: `scl-body`, style: { paddingRight: '26px' } }, content));
    }
    if (editable) {
      const props = Object.assign(Object.assign({ type: 'text' }, textFieldProps), { value: content, label });
      // TODO: use blur to reduce number of changes - but doesn't pass value
...
const ActionsCell = {
  ...
  render: ({ content }) => {
    return (index.h("div", { class: `tbody__actions` }, content.map((action) => {
      const { label, iconName, tooltip } = action, props = __rest(action, ["label", "iconName", "tooltip"]);
      ...
      if (typeof label === 'object' && '__html' in label) {
        return (index.h("scale-button", Object.assign({ size: "small", innerHTML: label.__html }, props, tooltipProps)));
      }
      return (index.h("scale-button", Object.assign({ size: "small" }, props, tooltipProps),
        IconComponent,
        label));
    })));
  },
...
function resolveIconComponent(iconName) {
  switch (iconName) {
    case 'edit':
      return index.h("scale-icon-action-edit", null);
    case 'delete':
      return index.h("scale-icon-action-remove", null);
    default:
      return null;
  }
}
...
function subMilliseconds(dirtyDate, dirtyAmount) {
  ...
  return index$1.addMilliseconds(dirtyDate, -amount);
}
...
function _possibleConstructorReturn(self, call) {
  if (call && (index$1._typeof(call) === "object" || typeof call === "function")) {
    return call;
  } else if (call !== void 0) {
...
function _toPrimitive(input, hint) {
  if (index$1._typeof(input) !== "object" || input === null) return input;
  var prim = input[Symbol.toPrimitive];
  if (prim !== undefined) {
    var res = prim.call(input, hint || "default");
    if (index$1._typeof(res) !== "object") return res;
...
function _toPropertyKey(arg) {
  ...
  return index$1._typeof(key) === "symbol" ? key : String(key);
}
...
function parse(dirtyDateString, dirtyFormatString, dirtyReferenceDate, options) {
  ...
  var firstWeekContainsDate = index$1.toInteger((_ref2 = (_ref3 = (_ref4 = (_options$firstWeekCon = options === null || options === void 0 ? void 0 : options.firstWeekContainsDate) !== null && _options$firstWeekCon !== void 0 ? _options$firstWeekCon : options === null || options === void 0 ? void 0 : (_options$locale2 = options.locale) === null || _options$locale2 === void 0 ? void 0 : (_options$locale2$opti = _options$locale2.options) === null || _options$locale2$opti === void 0 ? void 0 : _options$locale2$opti.firstWeekContainsDate) !== null && _ref4 !== void 0 ? _ref4 : defaultOptions.firstWeekContainsDate) !== null && _ref3 !== void 0 ? _ref3 : (_defaultOptions$local = defaultOptions.locale) === null || _defaultOptions$local === void 0 ? void 0 : (_defaultOptions$local2 = _defaultOptions$local.options) === null || _defaultOptions$local2 === void 0 ? void 0 : _defaultOptions$local2.firstWeekContainsDate) !== null && _ref2 !== void 0 ? _ref2 : 1);

  // Test if weekStartsOn is between 1 and 7 _and_ is not NaN
  if (!(firstWeekContainsDate >= 1 && firstWeekContainsDate <= 7)) {
    throw new RangeError('firstWeekContainsDate must be between 1 and 7 inclusively');
  }
  var weekStartsOn = index$1.toInteger((_ref5 = (_ref6 = (_ref7 = (_options$weekStartsOn = options === null || options === void 0 ? void 0 : options.weekStartsOn) !== null && _options$weekStartsOn !== void 0 ? _options$weekStartsOn : options === null || options === void 0 ? void 0 : (_options$locale3 = options.locale) === null || _options$locale3 === void 0 ? void 0 : (_options$locale3$opti = _options$locale3.options) === null || _options$locale3$opti === void 0 ? void 0 : _options$locale3$opti.weekStartsOn) !== null && _ref7 !== void 0 ? _ref7 : defaultOptions.weekStartsOn) !== null && _ref6 !== void 0 ? _ref6 : (_defaultOptions$local3 = defaultOptions.locale) === null || _defaultOptions$local3 === void 0 ? void 0 : (_defaultOptions$local4 = _defaultOptions$local3.options) === null || _defaultOptions$local4 === void 0 ? void 0 : _defaultOptions$local4.weekStartsOn) !== null && _ref5 !== void 0 ? _ref5 : 0);
  ...
  try {
    ...
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _ret = _loop();
      if (index$1._typeof(_ret) === "object") return _ret.v;
    }
  ...
  var utcDate = subMilliseconds(date, index$1.getTimezoneOffsetInMilliseconds(date));
  var flags = {};
...
const DataGrid = class {
  ...
  constructor(hostRef) {
    ...
    this.scaleSelection = index.createEvent(this, "scale-selection", 7);
  ...
  rowsHandler() {
    ...
    if (this.activeSortingIndex !== -1) {
      this.sortTable(this.fields[this.activeSortingIndex].sortDirection, this.fields[this.activeSortingIndex].type, this.activeSortingIndex, true);
    }
  }
  /* 8. Public Methods */
  /* 9. Local Methods */
  ...
  getCssClassMap() {
    return index$2.classnames(name, !this.isMobile && `${name}--desktop`, this.isMobile && `${name}--mobile`, this.shadeAlternate && `${name}--shade-alternate`, this.freezeHeader && `${name}--freeze-header`, this.hideBorder && `${name}--hide-border`, this.hideMenu && `${name}--hide-menu`, !this.heading && `${name}--no-heading`);
  }
  ...
  getDefaultLongestContent({ rows, columnIndex }) {
    ...
    rows.forEach((row) => {
      var _a, _b;
      const length = ((_b = (_a = row[columnIndex]) === null || _a === void 0 ? void 0 : _a.toString()) === null || _b === void 0 ? void 0 : _b.length) || 0;
      if (length > maxLength) {
  ...
  updateReadableSelection() {
    ...
    utils.emitEvent(this, 'scaleSelection', this.selection);
  ...
  toggleTableSorting(currentSortDirection, columnIndex, type) {
    ...
    this.activeSortingIndex = columnIndex;
    const newSortDirection = currentSortDirection === 'none'
      ? 'ascending'
      ...
      switch ((CELL_TYPES[type] &&
        ...
        case 'date':
          if (sortDirection === 'ascending') {
            this.rows.sort((a, b) => {
              var _a, _b;
              const textA = (_a = a[columnIndex]) === null || _a === void 0 ? void 0 : _a.toLowerCase();
              const textB = (_b = b[columnIndex]) === null || _b === void 0 ? void 0 : _b.toLowerCase();
  ...
  presortTable() {
    ...
    const direction = columnToPresort.presortDirection === 'descending'
      ? 'descending'
      : 'ascending';
    this.activeSortingIndex = columnIndex;
  ...
  renderSettingsMenu() {
    var _a, _b, _c, _d;
    return (index.h("scale-menu-flyout", { class: `${name}__settings-menu` }, index.h("scale-button", { slot: "trigger", variant: "secondary", "icon-only": true, "data-sortable": this.isSortable }, index.h("scale-icon-service-settings", { accessibilityTitle: ((_a = this.localization) === null || _a === void 0 ? void 0 : _a.tableOptions) || 'Table options' })), index.h("scale-menu-flyout-list", null, this.isSortable && (index.h("scale-menu-flyout-item", { id: "sortBy", onClick: this.handleMenuListClick }, index.h("scale-icon-action-sort", { slot: "prefix" }), ((_b = this.localization) === null || _b === void 0 ? void 0 : _b.sortBy) || 'Sort By', index.h("scale-menu-flyout-list", { slot: "sublist", id: "sortByList" }, this.fields.map(({ label, type, sortable, sortDirection = 'none' }, columnIndex) => {
      if (!sortable) {
        return '';
      }
    ...
    })))), index.h("scale-menu-flyout-item", { id: "toggleVisibility", onClick: this.handleMenuListClick }, index.h("scale-icon-action-hide-password", { slot: "prefix" }), ((_c = this.localization) === null || _c === void 0 ? void 0 : _c.toggle) || 'Toggle Visibility', index.h("scale-menu-flyout-list", { slot: "sublist", "close-on-select": "false", id: "toggleVisibilityList" }, this.fields.map(({ label, type, visible = CELL_TYPES[type].defaults.visible !== undefined
  ...
  renderTableHead() {
    var _a;
    return (index.h("thead", { ref: (el) => (this.elTableHead = el), class: `thead ${this.hideHeader ? 'sr-only' : ''}` }, index.h("tr", { class: `thead__row` }, this.numbered && this.renderTableHeadNumberedCell(), this.selectable && this.renderTableHeadSelectableCell(), (_a = this.fields) === null || _a === void 0 ? void 0 :
      _a.map(({ type, label = '', 
      ...
      visible = CELL_TYPES[type].defaults.visible !== undefined
        ...
        return (index.h("th", Object.assign({ title: sortable ? this.sortableColumnTitle : undefined }, props, (sortable
          ? {
            onKeyDown: (event) => {
          ...
          : {})), index.h("div", { class: `thead__title` }, index.h("span", { class: `thead__text` }, sortable && (index.h("scale-icon-content-sort-indicator-up", { size: 16, class: `thead__arrow-top` })), sortable && (index.h("scale-icon-content-sort-indicator-down", { size: 16, class: `thead__arrow-bottom` })), label)), resizable && (index.h("div", { class: `thead__divider`, "data-index": columnIndex, "data-width": width, "data-min": minWidth, "data-max": maxWidth, onMouseDown: (e) => this.onDividerDown(e), onTouchStart: (e) => this.onDividerDown(e), "aria-hidden": "true" }, index.h("div", { class: `thead__divider-line` })))));
      }))));
  }
  ...
  renderTableHeadSelectableCell() {
    ...
    return (index.h("th", { class: `thead__cell thead__cell--selection`, style: style, title: "Select" }, index.h("scale-checkbox", { ref: (el) => (this.elToggleSelectAll = el), onScaleChange: () => this.toggleSelectAll(), hideLabel: true, ariaLabelCheckbox: "Select" })));
  }
  renderTableBody() {
      ...
      for (let rowIndex = start; rowIndex < end; rowIndex++) {
        ...
        if (rowNestedContent.length) {
          rows.push(index.h("div", { class: `tbody__nested`, style: {
            ...
            return (content && (index.h("div", { ref: (el) => {
                if (el) {
  ...
  render() {
    ...
    return (index.h(index.Host, { style: {
      ...
      } }, this.styles && index.h("style", null, this.styles), index.h("div", { class: this.getCssClassMap() }, index.h("div", { class: `${name}__title-block`, part: "title" }, this.heading && (index.h("h4", { class: `${name}__heading scl-h5` }, this.heading)), index.h("div", null, index.h("slot", null)), this.hasData && this.renderSettingsMenu()), this.hasData && this.renderTable(), this.hasData &&
      !this.hideInfo &&
