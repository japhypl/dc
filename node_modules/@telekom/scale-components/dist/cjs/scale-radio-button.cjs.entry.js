...
const RadioButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: this.getCssClassMap() }, index.h("input", Object.assign({ type: "radio", name: this.name, id: this.inputId, onChange: this.handleCheckedChange, value: this.value, checked: this.checked, disabled: this.disabled }, ariaInvalidAttr, (this.helperText || this.ariaDetailsId
      ? ariaDescribedByAttr
      : {}), { "aria-details": this.ariaDetailsId })), index.h("label", { htmlFor: this.inputId }, this.label), !!this.helperText && (index.h("div", { class: "radio-button__meta", id: helperTextId, "aria-live": "polite", "aria-relevant": "additions removals" }, this.renderHelperIcon(), index.h("div", { class: "radio-button__helper-text" }, this.helperText))))));
  }
  getCssClassMap() {
