...
const Chip = class {
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("span", { role: this.ariaRoleTitle, "aria-checked": this.selected.toString(), tabindex: this.disabled ? '-1' : '0', part: this.getBasePartMap(), class: this.getCssClassMap(), onClick: this.handleClick, onKeyDown: this.handleKeyDown }, index.h("slot", { name: "chip-icon" }), index.h("span", { class: "chip-label" }, index.h("slot", null)), this.selected ? this.getIcon() : null)));
  }
  getBasePartMap() {
