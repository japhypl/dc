...
const Checkbox = class {
  constructor(hostRef) {
    ...
    this.handleChange = (ev) => {
      ...
      utils.emitEvent(this, 'scaleChange', { checked, indeterminate, value, disabled });
    };
  }
  componentDidRender() {
    if (this.status !== '') {
  ...
  renderIcon() {
    if (this.indeterminate) {
      return (index.h("scale-icon-action-minus", { part: "icon", decorative: true }));
    }
    if (this.checked) {
      return (index.h("scale-icon-action-checkmark", { part: "icon", decorative: true }));
    }
  }
  renderHelperIcon() {
  ...
  renderHelperText(text) {
    if (this.helperText && this.helperText !== '') {
      return (index.h("div", { part: "helper-text", id: text.id, "aria-live": "polite", "aria-relevant": "additions removals" }, this.renderHelperIcon(), text.content));
    }
  }
  render() {
    const helperText = {
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("input", { type: "checkbox", part: "input", name: this.name || null, id: this.inputId, value: this.value, checked: this.checked, indeterminate: this.indeterminate, "aria-label": this.ariaLabelCheckbox, "aria-checked": this.indeterminate ? 'mixed' : false, "aria-invalid": this.status === 'error' || this.invalid ? 'true' : null, "aria-describedBy": helperText ? helperText.id : this.ariaDetailsId, "aria-details": this.ariaDetailsId, disabled: this.disabled, required: this.required, onChange: this.handleChange }), index.h("label", { part: "container", htmlFor: this.inputId }, index.h("span", { part: "checkbox" }, this.renderIcon()), index.h("span", { part: "label" }, this.label || index.h("slot", null))), this.renderHelperText(helperText)));
  }
...
const ActionMinus = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("svg", Object.assign({ class: "scale-icon", xmlns: "http://www.w3.org/2000/svg", width: this.size, height: this.size, viewBox: "0 0 24 24" }, ariaHidden, focusable), this.accessibilityTitle && index.h("title", null, this.accessibilityTitle), index.h("g", { fill: ((this.fill === 'currentColor') ? this.color : this.fill) }, this.selected ? (index.h("g", null, index.h("path", { d: "M19.5 10.75h-15a1.25 1.25 0 000 2.5h15a1.25 1.25 0 100-2.5z", "fill-rule": "evenodd" }))) : (index.h("g", null, index.h("path", { d: "M19.5 12.75h-15a.75.75 0 110-1.5h15a.75.75 0 110 1.5z", "fill-rule": "evenodd" })))))));
  }
  get hostElement() { return index.getElement(this); }
};
ActionMinus.style = iconCss;

exports.scale_checkbox = Checkbox;
exports.scale_icon_action_minus = ActionMinus;
