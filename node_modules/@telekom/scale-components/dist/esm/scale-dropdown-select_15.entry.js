...
import { c as computePosition } from './floating-ui.dom.esm-43ac86e1.js';
import { e as emitEvent, g as generateUniqueId, c as isPseudoClassSupported } from './utils-c4af5b47.js';
...
const DropdownSelect = class {
  ...
  render() {
    ...
    return (h(Host, null, h("div", { part: this.getBasePartMap() }, h("div", { part: "combobox-container" }, h("label", { id: `${this.comboboxId}-label`, part: "label" }, this.label), h("div", Object.assign({ ref: (el) => (this.comboEl = el), "aria-controls": `${this.comboboxId}-listbox`, "aria-expanded": this.open ? 'true' : 'false', "aria-haspopup": "listbox", "aria-labelledby": `${this.comboboxId}-label`, "aria-details": this.ariaDetailsId, id: this.comboboxId, part: "combobox", role: "combobox", tabindex: this.disabled ? '-1' : '0', onBlur: this.handleBlur, onFocus: this.handleFocus, onClick: this.handleClick, onKeyDown: this.handleKeyDown }, (this.open
      ...
      : {}), ariaDescribedByAttr, (this.invalid ? { 'aria-invalid': 'true' } : {})), h("span", { part: "combobox-value" }, hasEmptyValueElement ? '' : ValueElement)), h("div", { part: "listbox-pad", ref: (el) => (this.listboxPadEl = el) }, h("div", { ref: (el) => (this.scrollContainer = el), part: "listbox-scroll-container", onMouseDown: (e) => {
        e.preventDefault();
      } }, h("div", { part: "listbox", role: "listbox", id: `${this.comboboxId}-listbox`, "aria-labelledby": `${this.comboboxId}-label`, tabindex: "-1" }, readOptions(this.hostElement).map(({ value, disabled, ItemElement }, index) => (h("div", Object.assign({ role: "option", part: this.getOptionPartMap(index, disabled), id: value, onClick: (event) => {
        this.handleOptionClick(event, index);
      } }, (value === this.value
      ? { 'aria-selected': 'true' }
      : {}), (disabled ? { 'aria-disabled': 'true' } : {})), ItemElement, value === this.value ? (h("div", null, h("scale-icon-action-checkmark", { size: 16 }), h("span", { class: "sr-only" }, this.ariaLabelSelected))) : null)))))), this.allowClear && this.value ? (h("scale-icon-action-close", { "accessibility-title": "close", part: "clear", onClick: this.handleClearClick })) : (h("div", { part: "icon" }, this.open ? (h("scale-icon-navigation-collapse-up", { decorative: true, size: DEFAULT_ICON_SIZE$1 })) : (h("scale-icon-navigation-collapse-down", { decorative: true, size: DEFAULT_ICON_SIZE$1 }))))), this.helperText && (h("scale-helper-text", { helperText: this.helperText, variant: this.invalid ? 'danger' : this.variant, id: helperTextId })), this.disabled && (h("div", { class: "hcm-disabled" }, this.hcmLabelDisabled)))));
  }
  getBasePartMap() {
...
const TextField = class {
  ...
  render() {
    ...
    const ariaDescribedByAttr = {
      'aria-describedBy': (this.helperText && helperTextId) || this.ariaDetailedId,
    };
