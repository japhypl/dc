...
export declare class DataGrid {
  ...
  toggleTableSorting(currentSortDirection: any, columnIndex: any, type: any): void;
  sortTable(sortDirection: any, type: any, columnIndex: any, shouldTriggerEvent?: boolean): void;
