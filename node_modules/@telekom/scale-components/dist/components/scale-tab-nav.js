...
const TabNav = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  selectNextTab(nextTab) {
    const tabs = this.getAllTabs();
    const tabToSelect = (!(nextTab === null || nextTab === void 0 ? void 0 : nextTab.disabled) && nextTab) ||
  ...
  static get style() { return tabNavCss; }
    ...
    "size": [1],
    "styles": [1]
  }, [[0, "scale-select", "handleSelect"], [0, "scale-disabled", "handleDisabledTabHeader"], [0, "keydown", "handleKeydown"]]]);
