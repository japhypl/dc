...
import { d as defineCustomElement$8 } from './helper-text.js';
import { d as defineCustomElement$7 } from './action-checkmark.js';
import { d as defineCustomElement$6 } from './action-close.js';
...
const DropdownSelect = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  static get style() { return dropdownSelectCss; }
    ...
    "ariaDetailsId": [1, "aria-details-id"],
...
function defineCustomElement() {
  ...
  const components = ["scale-dropdown-select", "scale-helper-text", "scale-icon-action-checkmark", "scale-icon-action-close", "scale-icon-action-success", "scale-icon-alert-error", "scale-icon-alert-information", "scale-icon-navigation-collapse-down", "scale-icon-navigation-collapse-up"];
