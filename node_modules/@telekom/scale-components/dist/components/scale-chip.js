...
import { d as defineCustomElement$3 } from './action-checkmark.js';
import { d as defineCustomElement$2 } from './action-close.js';
...
const Chip = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    return (h(Host, null, this.styles && h("style", null, this.styles), h("span", { role: this.ariaRoleTitle, "aria-checked": this.selected.toString(), tabindex: this.disabled ? '-1' : '0', part: this.getBasePartMap(), class: this.getCssClassMap(), onClick: this.handleClick, onKeyDown: this.handleKeyDown }, h("slot", { name: "chip-icon" }), h("span", { class: "chip-label" }, h("slot", null)), this.selected ? this.getIcon() : null)));
  }
  getBasePartMap() {
...
function defineCustomElement$1() {
  ...
  const components = ["scale-chip", "scale-icon-action-checkmark", "scale-icon-action-close"];
...
const ScaleChip = Chip;
const defineCustomElement = defineCustomElement$1;

export { ScaleChip, defineCustomElement };
