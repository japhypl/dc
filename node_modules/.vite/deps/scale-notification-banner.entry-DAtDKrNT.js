...
//#region node_modules/@telekom/scale-components/dist/esm/scale-notification-banner.entry.js
...
var NotificationBanner = class {
	...
	render() {
		...
		return h(Host, null, h("div", {
			...
			part: "container",
			class: "notification-banner__container"
		}, this.handleIcons(), h("div", {
			part: "heading",
			class: "notification-banner__heading"
		}, h("slot", null), this.dismissible && h("button", {
		...
		}, h("scale-icon-action-circle-close", null)), this.hasSlotText && h("div", {
			part: "text",
			class: "notification-banner__text"
		}, h("slot", { name: "text" })), this.hasSlotLink && h("scale-link", {
			href: this.href,
...
//# sourceMappingURL=scale-notification-banner.entry-DAtDKrNT.js.map