...
//#region node_modules/@telekom/scale-components/dist/esm/scale-collapsible.entry.js
...
var Collapsible = class {
	...
	*/
	...
	render() {
		...
		return h(Host, null, this.styles && h("style", null, this.styles), h("div", {
		...
		}, this.iconLocation === "left" ? h(IconTag, {
			...
			part: "button-text"
		}, h("slot", { name: "heading" })), this.iconLocation === "right" ? h(IconTag, {
			size: DEFAULT_ICON_SIZE,
			decorative: true,
...
//# sourceMappingURL=scale-collapsible.entry-LH4rJSrk.js.map