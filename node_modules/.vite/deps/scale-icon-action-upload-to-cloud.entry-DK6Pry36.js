...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-action-upload-to-cloud.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var ActionUploadToCloud = class {
	constructor(hostRef) {
...
ActionUploadToCloud.style = iconCss;
//#endregion
export { ActionUploadToCloud as scale_icon_action_upload_to_cloud };

//# sourceMappingURL=scale-icon-action-upload-to-cloud.entry-DK6Pry36.js.map