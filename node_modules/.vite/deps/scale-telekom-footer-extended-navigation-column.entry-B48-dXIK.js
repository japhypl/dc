...
//#region node_modules/@telekom/scale-components/dist/esm/scale-telekom-footer-extended-navigation-column.entry.js
...
var TelekomFooterExtendedNavigationColumn = class {
	...
	render() {
		return h(Host, null, h("div", { part: classnames("telekom-footer-extended-navigation-column", { expanded: this.expanded }) }, h("div", { part: "heading-container" }, h("span", {
			role: "heading",
			...
			part: "heading-button"
		}, h("span", null, " ", this.heading), h("scale-icon-navigation-collapse-down", {
			selected: true,
			size: 16
		}))), h("span", {
			part: "heading",
			role: "heading",
			"aria-level": this.headingLevel
		}, this.heading)), h("div", { part: classnames("telekom-footer-extended-navigation-column-links", this.expanded ? "links-expanded" : "links-hidden") }, h("slot", null))));
	}
	get hostElement() {
...
//#endregion
export { TelekomFooterExtendedNavigationColumn as scale_telekom_footer_extended_navigation_column };

//# sourceMappingURL=scale-telekom-footer-extended-navigation-column.entry-B48-dXIK.js.map