...
//#region node_modules/@telekom/scale-components/dist/esm/scale-chart-stack-card.entry.js
  ...
  `;
	...
	render() {
		return h(Host, null, h("div", { class: this.getCssClassMap() }, h("scale-card", { styles: this.getCardStyle() }, h("div", { class: "header" }, this.heading), h("div", { class: "bar" }, this.readData(this.data).sort((a, b) => b.percentage - a.percentage).map((item, index) => {
			if (+item.percentage > 0) return h("div", {
				class: "bar__item",
				style: {
		...
		})), h("div", { class: "legend" }, this.readData(this.data).sort((a, b) => b.percentage - a.percentage).map((item, index) => h("div", { class: "legend__row" }, h("div", { class: "legend__row__item" }, h("div", {
			class: "legend__item",
			style: { opacity: this.getOpacity(item, index) }
...
//# sourceMappingURL=scale-chart-stack-card.entry-DcnHxKhP.js.map