...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-t-product-magentaone.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var TProductMagentaone = class {
	constructor(hostRef) {
...
TProductMagentaone.style = iconCss;
//#endregion
export { TProductMagentaone as scale_icon_t_product_magentaone };

//# sourceMappingURL=scale-icon-t-product-magentaone.entry-BDF31d06.js.map