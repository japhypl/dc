...
//#region node_modules/@telekom/scale-components/dist/esm/scale-breadcrumb.entry.js
...
var Breadcrumb = class {
	...
	componentWillLoad() {
		if (this.linksArray.length === 0) this.setLinksArray();
	...
	render() {
		...
		return h(Host, null, this.styles && h("style", null, this.styles), h("nav", {
			...
			const separator = this.separatorSlot != null ? h("span", {
				...
				class: "breadcrumb__separator",
				part: "separator"
			}, this.separator || h("scale-icon-navigation-right", { size: 12 }));
			return h("li", {
...
//# sourceMappingURL=scale-breadcrumb.entry-DXef6aMn.js.map