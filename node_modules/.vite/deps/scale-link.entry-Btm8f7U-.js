...
//#region node_modules/@telekom/scale-components/dist/esm/scale-link.entry.js
...
var Link = class {
	...
	render() {
		...
		} }, this.styles && h("style", null, this.styles), h("a", Object.assign({
			part: "anchor",
			ref: (el) => this.focusableElement = el
		}, this.getAnchorProps()), h("div", { part: "content" }, h("slot", null)), h("slot", { name: "icon" })));
	}
};
Link.style = linkCss;
//#endregion
export { Link as scale_link };

//# sourceMappingURL=scale-link.entry-Btm8f7U-.js.map