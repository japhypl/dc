...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-communication-landing-mobile-contact-client.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var CommunicationLandingMobileContactClient = class {
	constructor(hostRef) {
...
//#endregion
export { CommunicationLandingMobileContactClient as scale_icon_communication_landing_mobile_contact_client };

//# sourceMappingURL=scale-icon-communication-landing-mobile-contact-client.entry-B09qYu4m.js.map