import { l as registerInstance, n as Host, s as h } from "./index-6d95a4bc-DlO5twzZ.js";
//#region node_modules/@telekom/scale-components/dist/esm/scale-helper-text.entry.js
...
var HelperText = class {
	...
	renderHelperIcon() {
		...
		if (variant === "informational" || variant === "warning") return h("scale-icon-alert-information", null);
		if (variant === "danger") return h("scale-icon-alert-error", null);
		if (variant === "success") return h("scale-icon-action-success", null);
	}
	render() {
		return h(Host, null, h("div", {
			...
			part: "base"
		}, this.helperText ? h("span", { part: "text" }, this.helperText) : h("span", { part: "text" }, h("slot", null)), this.renderHelperIcon()), this.styles && h("style", null, this.styles));
	}
};
...
//# sourceMappingURL=scale-helper-text.entry-DLwwoOm5.js.map