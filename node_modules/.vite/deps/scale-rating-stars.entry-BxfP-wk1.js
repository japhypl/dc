...
//#region node_modules/@telekom/scale-components/dist/esm/scale-rating-stars.entry.js
...
var RatingStars = class {
	constructor(hostRef) {
		...
		this.handleStarClick = (ev) => {
			...
			if (starValue === 1 && this.rating === 1 && this.minRating === 0) this.rating = this.minRating;
			else this.rating = starValue;
			emitEvent(this, "scaleChange", { value: this.rating });
		};
	}
	componentWillRender() {
		...
		if (this.minRating !== 0) statusNote({
			tag: "deprecated",
	...
	getRatingText() {
		return this.ariaLabelTranslation.replace(/\$rating/g, `${this.rating}`).replace(/\$maxRating/g, `${this.max}`).replace(/\$max/g, `${this.max}`);
	}
	...
	render() {
		...
		} }, h("div", { part: "container" }, h("label", {
			id: `${this.ratingStarId}-label`,
			part: "label",
			htmlFor: this.ratingStarId
		}, this.label), h("div", { part: "content" }, h("div", {
			part: "wrapper",
			"aria-valuetext": this.getRatingText(),
			"aria-orientation": "horizontal",
			"aria-describedby": this.infoText ? `${this.ratingStarId}-infotext` : false
		}, h("input", {
			disabled: this.disabled,
			readonly: this.readonly,
			part: "range-slider",
...
//# sourceMappingURL=scale-rating-stars.entry-BxfP-wk1.js.map