...
//#region node_modules/@telekom/scale-components/dist/esm/app-logo.entry.js
var appLogoCss = ".logo{display:flex;align-items:center}.logo>svg{width:100%;max-width:300px;height:auto}";
var Logo = class {
	constructor(hostRef) {
	...
	render() {
		if (!this.claim) return h("a", {
			href: this.href,
			title: this.logoTitle,
			tabindex: this.focusable === false ? -1 : void 0
		}, h("svg", {
			width: "51",
			height: "24",
			viewBox: "0 0 51 24",
...
//#endregion
export { Logo as app_logo };

//# sourceMappingURL=app-logo.entry-C5ZcYTKa.js.map