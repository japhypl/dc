...
//#region node_modules/@telekom/scale-components/dist/esm/scale-app-shell.entry.js
...
var Shell = class {
	...
	render() {
		return h(Host, null, this.styles && h("style", null, this.styles), h("div", {
			part: "base",
			class: "shell"
		}, this.hasSlotHeader ? h("slot", { name: "header" }) : h("scale-app-header", {
		...
		}), h("main", { class: "content" }, h("slot", null)), h("slot", { name: "footer" })));
	}
	get hostElement() {
...
//# sourceMappingURL=scale-app-shell.entry-Df4rFxmV.js.map