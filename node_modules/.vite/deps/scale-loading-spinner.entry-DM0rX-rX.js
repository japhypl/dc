...
var LoadingSpinner = class {
	...
	render() {
		return h(Host, null, h("div", {
			...
			"aria-live": "polite",
			id: `spinner-label-${i}`
		}, this.accessibilityTitle ? this.accessibilityTitle : this.text || "Loading"), this.text ? h("div", {
			part: "text",
			class: "spinner__text",
			"aria-hidden": "true"
...
//# sourceMappingURL=scale-loading-spinner.entry-DM0rX-rX.js.map