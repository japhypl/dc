...
//#region node_modules/@telekom/scale-components/dist/esm/scale-alert.entry.js
...
var Alert = class {
	constructor(hostRef) {
		...
		this.onCloseAlertWithTimeout = () => {
			if (this.timeout !== false) if (typeof this.timeout === "number") setTimeout(this.close, this.timeout);
			else setTimeout(this.close, this.defaultTimeout);
			else return null;
		};
	}
	componentWillLoad() {
	...
	render() {
		...
		return h(Host, null, this.styles && h("style", null, this.styles), h("div", { class: this.getCssClassMap() }, h("div", { class: "alert__body" }, h("div", { class: "alert__icon" }, this.icon), h("div", { class: "alert__content" }, h("div", { class: "alert__headline" }, this.headline), h("slot", null))), h("a", {
			class: "alert__close",
			onClick: this.close
		}, this.hasSlotClose ? h("div", { class: "alert__close-icon" }, h("slot", { name: "close" })) : "x")));
	}
	getCssClassMap() {
...
//# sourceMappingURL=scale-alert.entry-CflEAvSU.js.map