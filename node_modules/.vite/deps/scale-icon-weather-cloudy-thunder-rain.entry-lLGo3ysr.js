...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-weather-cloudy-thunder-rain.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var WeatherCloudyThunderRain = class {
	constructor(hostRef) {
...
//#endregion
export { WeatherCloudyThunderRain as scale_icon_weather_cloudy_thunder_rain };

//# sourceMappingURL=scale-icon-weather-cloudy-thunder-rain.entry-lLGo3ysr.js.map