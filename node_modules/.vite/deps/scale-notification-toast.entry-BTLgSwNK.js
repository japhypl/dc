...
//#region node_modules/@telekom/scale-components/dist/esm/scale-notification-toast.entry.js
...
var NotificationToast = class {
  ...
  `;
	...
	componentDidRender() {
		if (this.autoHide === true) setTimeout(this.close, this.autoHideDuration);
	}
	handleIcons() {
		if (this.variant) switch (this.variant) {
			case "success": return h("scale-icon-action-success", {
			...
			case "informational": return h("scale-icon-alert-information", {
				class: "notification-toast__icon",
				size: 20,
				selected: true,
				color: "#ffffff",
			...
			case "error": return h("scale-icon-alert-error", {
				class: "notification-toast__icon",
				size: 20,
				selected: true,
				color: "#ffffff",
			...
			case "warning": return h("scale-icon-alert-warning", {
				class: "notification-toast__icon",
				color: "#ffff",
				size: 20,
				selected: true,
	...
	render() {
		if (this.opened) return h(Host, null, this.styles && h("style", null, this.styles), h("style", null, this.transitions(this.toastHeightWithOffset)), h("style", null, this.animationStyle(this.toastHeightWithOffset)), h("div", {
			role: "alert",
			style: { display: `${this.opened ? "" : "none"}` },
			class: this.getCssClassMap(),
			part: this.getBasePartMap(),
			tabindex: "0"
		}, h("div", { class: "notification-toast__icon-container" }, this.handleIcons()), h("div", { class: "notification-toast__text-container" }, h("slot", { name: "header" }), h("slot", { name: "body" }), h("scale-link", {
			href: this.href,
			class: "notification-toast__link",
			role: "link"
		}, h("slot", { name: "link" }))), h("button", {
...
//# sourceMappingURL=scale-notification-toast.entry-BTLgSwNK.js.map