...
//#region node_modules/@telekom/scale-components/dist/esm/scale-checkbox_2.entry.js
...
var Checkbox = class {
	constructor(hostRef) {
		...
		this.handleChange = (ev) => {
			...
			} else this.checked = ev.target.checked;
	...
	componentDidRender() {
		...
		if (this.host.hasAttribute("aria-label")) statusNote({
			tag: "deprecated",
	...
	connectedCallback() {
		if (!this.inputId) this.inputId = "input-checkbox-" + this.internalId;
	}
	renderIcon() {
		if (this.indeterminate) return h("scale-icon-action-minus", {
			part: "icon",
			decorative: true
		});
		if (this.checked) return h("scale-icon-action-checkmark", {
			part: "icon",
			decorative: true
		});
	}
	renderHelperIcon() {
		if (this.helperText && !this.invalid) return h("scale-icon-alert-information", { size: 11 });
		if (this.invalid) return h("scale-icon-alert-error", { size: 11 });
	}
	renderHelperText(text) {
		if (this.helperText && this.helperText !== "") return h("div", {
			part: "helper-text",
			id: text.id,
			"aria-live": "polite",
			"aria-relevant": "additions removals"
		}, this.renderHelperIcon(), text.content);
	}
	render() {
		const helperText = {
		...
		}, h("span", { part: "checkbox" }, this.renderIcon()), h("span", { part: "label" }, this.label || h("slot", null))), this.renderHelperText(helperText));
	}
	get host() {
...
var ActionMinus = class {
	...
	render() {
		...
		return h(Host, null, h("svg", Object.assign({
			...
			d: "M19.5 10.75h-15a1.25 1.25 0 000 2.5h15a1.25 1.25 0 100-2.5z",
			"fill-rule": "evenodd"
		})) : h("g", null, h("path", {
			d: "M19.5 12.75h-15a.75.75 0 110-1.5h15a.75.75 0 110 1.5z",
			"fill-rule": "evenodd"
		})))));
	}
	get hostElement() {
...
//# sourceMappingURL=scale-checkbox_2.entry-Cat23TbT.js.map