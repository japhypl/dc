...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-weather-cloudy-sleet.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var WeatherCloudySleet = class {
	constructor(hostRef) {
...
WeatherCloudySleet.style = iconCss;
//#endregion
export { WeatherCloudySleet as scale_icon_weather_cloudy_sleet };

//# sourceMappingURL=scale-icon-weather-cloudy-sleet.entry-DJQHEaU8.js.map