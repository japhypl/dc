...
//#region node_modules/@telekom/scale-components/dist/esm/scale-sidebar-nav-collapsible.entry.js
...
var SidebarNavCollapsible = class {
	constructor(hostRef) {
		...
		*/
		this.handleKeydown = (event) => {
			...
			if (event.code === "Space") this.expanded = !this.expanded;
		};
	}
	nestingLevelChanged(newValue) {
		if (newValue === 1) this.bold = true;
	}
	render() {
		const Tag = this.tag;
		return h(Host, null, this.styles && h("style", null, this.styles), h(Tag, {
			...
			class: "sidebar-nav-collapsible__wrapper",
			part: "wrapper"
		}, h("a", {
			href: this.href,
		...
		}, this.label, h("scale-icon-navigation-collapse-down", {
	...
	static get watchers() {
		return { "nestingLevel": ["nestingLevelChanged"] };
	}
};
SidebarNavCollapsible.style = sidebarNavCollapsibleCss;
//#endregion
export { SidebarNavCollapsible as scale_sidebar_nav_collapsible };

//# sourceMappingURL=scale-sidebar-nav-collapsible.entry-CoiwwCiu.js.map