...
//#region node_modules/@telekom/scale-components/dist/esm/scale-card.entry.js
...
var Card = class {
	...
	render() {
		...
		}, !this.to ? { role: "group" } : {}, !!this.to ? { href: this.to } : {}, !!this.target ? { target: this.target } : {}, !!this.rel ? { rel: this.rel } : {}, !!this.label ? { ["aria-label"]: this.label } : {}), h("div", {
			class: "card__body",
			part: "body"
		}, h("slot", null)))));
	}
...
//# sourceMappingURL=scale-card.entry-B9dfS-PK.js.map