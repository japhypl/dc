...
var AppFooter = class {
	...
	render() {
		return h(Host, null, this.styles && h("style", null, this.styles), h("div", { class: this.getCssClassMap() }, h("div", { class: "footer-mask" }), h("footer", { class: "footer" }, h("div", { class: "footer-content" }, h("div", { class: "footer-branding" }, this.hasSlotLogo ? h("slot", { name: "logo" }) : h("scale-logo", {
			transparent: true,
			variant: "white",
			size: 24,
			href: this.logoHref,
		...
		})), h("div", { class: "footer-copyright" }, this.copyright), h("nav", {
			"aria-label": "bottom",
			class: "footer-navigation"
		}, this.hasSlotNavigation ? h("slot", { name: "navigation" }) : h("ul", null, readData(this.footerNavigation).map((item) => h("li", { class: "footer-navigation__item" }, h("a", {
...
//#endregion
export { AppFooter as scale_app_footer };

//# sourceMappingURL=scale-app-footer.entry-jsjyowXi.js.map