...
//#region node_modules/@telekom/scale-components/dist/esm/scale-dropdown.entry.js
...
var Dropdown = class {
	...
	componentWillLoad() {
		...
		if (this.inputId == null) this.inputId = "input-dropdown-" + this.internalId;
	}
	componentDidLoad() {
	...
	componentDidRender() {
		...
		if (this.controlled && this.selectElement.value.toString() !== value) this.selectElement.value = value;
	...
	render() {
		...
		}, this.label), h("div", { class: "input__dropdown-wrapper" }, h("select", Object.assign({
		...
		}, ariaInvalidAttr, this.helperText || this.ariaDetailsId ? ariaDescribedByAttr : {}, { "aria-details": this.ariaDetailsId }), h("slot", null)), h("div", { class: "input__dropdown-icon" }, this.hasSlotIcon ? h("slot", { name: "icon" }) : h("scale-icon-navigation-collapse-down", {
			size: 20,
			decorative: true
...
//#endregion
export { Dropdown as scale_dropdown };

//# sourceMappingURL=scale-dropdown.entry-DbBUDgkA.js.map