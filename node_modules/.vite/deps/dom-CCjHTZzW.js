//#region node_modules/@telekom/scale-components/dist/esm/polyfills/dom.js
(function() {
	"use strict";
	...
	function A(a, b, d) {
		d = void 0 === d ? {} : d;
		var c = d.u || /* @__PURE__ */ new Set(), e = d.i || function(b) {
			return y(a, b);
		}, f = [];
		p(b, function(b) {
	...
	E.prototype.m = function(a) {
		if (!g(a)) return Promise.reject(/* @__PURE__ */ new SyntaxError("'" + a + "' is not a valid custom element name."));
		var b = this.j.get(a);
		if (b) return b.c;
		b = new ea();
		this.j.set(a, b);
...
//# sourceMappingURL=dom-CCjHTZzW.js.map