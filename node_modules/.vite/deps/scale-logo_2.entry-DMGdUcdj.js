...
//#region node_modules/@telekom/scale-components/dist/esm/scale-logo_2.entry.js
...
var Logo = class {
	...
	render() {
		return h(Host, { exportparts: "logo-svg" }, h("style", null, this.size ? `:host { --logo-size: ${this.size}px; }` : "", this.styles), h("a", {
			href: this.href,
			part: this.getCssClassMap(),
			tabindex: this.focusable === false ? "-1" : "0",
			onFocus: () => {
				if (this.scrollIntoViewOnFocus === true) window.scrollTo({ top: 0 });
			},
			title: this.logoHideTitle ? void 0 : this.logoTitle,
...
var LogoSvg = class {
	constructor(hostRef) {
		...
		this.getTitle = (title, linkAddition) => {
			if (!this.logoHideTitle) return this.logoTitle ? h("title", { id: `logo-title-${i}` }, this.logoTitle) : h("title", { id: `logo-title-${i}` }, `${title} ${this.innerRole === "link" ? linkAddition : ""}`);
		};
	}
	componentWillLoad() {
		i++;
	...
	getColor() {
		return this.color, colors[this.color];
	}
	render() {
		...
		}, this.getTitle("Telekom Logo", "- Go to Start Page"), h("path", { d: "M7.6 25.1H0v-7.6h7.6v7.6ZM0 0v12.9h2.3v-.4c0-6.1 3.4-9.9 9.9-9.9h.4V30c0 3.8-1.5 5.3-5.3 5.3H6.1V38h19.8v-2.7h-1.1c-3.8 0-5.3-1.5-5.3-5.3V2.7h.4c6.5 0 9.9 3.8 9.9 9.9v.4h2.3V0H0Zm24.3 25.1h7.6v-7.6h-7.6v7.6Z" })));
	}
	get hostElement() {
		return getElement(this);
	}
...
//# sourceMappingURL=scale-logo_2.entry-DMGdUcdj.js.map