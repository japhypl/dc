...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-communication-loyalty-earned.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var CommunicationLoyaltyEarned = class {
	constructor(hostRef) {
...
//#endregion
export { CommunicationLoyaltyEarned as scale_icon_communication_loyalty_earned };

//# sourceMappingURL=scale-icon-communication-loyalty-earned.entry-0pHgIBjK.js.map