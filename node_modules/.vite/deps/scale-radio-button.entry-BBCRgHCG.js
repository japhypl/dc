...
//#region node_modules/@telekom/scale-components/dist/esm/scale-radio-button.entry.js
...
var RadioButton = class {
	...
	render() {
		...
		}, ariaInvalidAttr, this.helperText || this.ariaDetailsId ? ariaDescribedByAttr : {}, { "aria-details": this.ariaDetailsId })), h("label", { htmlFor: this.inputId }, this.label), !!this.helperText && h("div", {
			class: "radio-button__meta",
			id: helperTextId,
			"aria-live": "polite",
			"aria-relevant": "additions removals"
		}, this.renderHelperIcon(), h("div", { class: "radio-button__helper-text" }, this.helperText))));
	}
	getCssClassMap() {
...
//# sourceMappingURL=scale-radio-button.entry-BBCRgHCG.js.map