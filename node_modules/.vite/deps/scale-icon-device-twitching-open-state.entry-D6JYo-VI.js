...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-device-twitching-open-state.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var DeviceTwitchingOpenState = class {
	constructor(hostRef) {
...
//#endregion
export { DeviceTwitchingOpenState as scale_icon_device_twitching_open_state };

//# sourceMappingURL=scale-icon-device-twitching-open-state.entry-D6JYo-VI.js.map