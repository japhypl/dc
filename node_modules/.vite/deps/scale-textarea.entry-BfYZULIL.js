...
//#region node_modules/@telekom/scale-components/dist/esm/scale-textarea.entry.js
...
var Textarea = class {
	...
	componentWillLoad() {
		if (this.inputId == null) this.inputId = "input-textarea-" + this.internalId;
	}
	componentDidRender() {
	...
	render() {
		...
		return h(Host, null, h("div", { class: this.getCssClassMap() }, h("div", {
			class: "textarea__wrapper",
			onClick: () => this.focusableElement.focus(),
			style: !!this.resize && this.resize === "horizontal" && { width: "max-content" }
		}, h("label", {
		...
		}, !!this.placeholder ? { placeholder: this.placeholder } : {}, { disabled: this.disabled }, readonlyAttr, !!this.rows ? { rows: this.rows } : {}, !!this.cols ? { cols: this.cols } : {}, ariaInvalidAttr, this.helperText || this.ariaDetailsId ? ariaDescribedByAttr : {}, {
		...
		}), this.counter && h("div", { class: "textarea__counter" }, !!this.value ? String(this.value).length : 0, " /", " ", this.maxLength))));
	}
	getCssClassMap() {
...
//# sourceMappingURL=scale-textarea.entry-BfYZULIL.js.map