//#region node_modules/@telekom/scale-components/dist/esm/polyfills/core-js.js
/**
* core-js 3.6.5
...
(function(t) {
	...
	(function(t) {
		...
		function(t, n, e) {
			var r = e(3), o = e(22);
			t.exports = r["__core-js_shared__"] || o("__core-js_shared__", {});
		},
		function(t, n, e) {
		...
		function(t, n, e) {
			t.exports = e(50) && !Symbol.sham && "symbol" == typeof Symbol.iterator;
		},
		function(t, n, e) {
		...
		function(t, n, e) {
			t.exports = e(34)("navigator", "userAgent") || "";
		},
		function(t, n, e) {
			...
			r({
				target: "Array",
				proto: !0
			}, { copyWithin: o }), i("copyWithin");
		},
		function(t, n, e) {
			var r = e(46), o = e(41), i = e(39), a = Math.min;
			t.exports = [].copyWithin || function(t, n) {
				var e = r(this), u = i(e.length), c = o(t, u), f = o(n, u), s = arguments.length > 2 ? arguments[2] : void 0, l = a((void 0 === s ? u : o(s, u)) - f, u - c), p = 1;
		...
		function(t, n, e) {
			var r, o = e(20), i = e(59), a = e(42), u = e(31), c = e(61), f = e(17), l = e(27)("IE_PROTO"), p = function() {}, h = function(t) {
		...
		function(t, n, e) {
			t.exports = e(34)("document", "documentElement");
		},
		function(t, n, e) {
		...
		function(t, n, e) {
			var r = e(64), o = e(10), i = e(46), a = e(39), u = e(48), c = [].push, f = function(t) {
				...
				return function(h, v, g, d) {
					for (var y, x, m = i(h), b = o(m), S = r(v, g, 3), E = a(b.length), w = 0, O = d || u, R = n ? O(h, E) : e ? O(h, 0) : void 0; E > w; w++) if ((p || w in b) && (x = S(y = b[w], w, m), t)) {
						if (n) R[w] = x;
						else if (x) switch (t) {
							case 3: return !0;
							case 5: return y;
		...
		function(t, n, e) {
			...
			t.exports = function(t, n) {
				if (i(u, t)) return u[t];
				n || (n = {});
				var e = [][t], f = !!i(n, "ACCESSORS") && n.ACCESSORS, s = i(n, 0) ? n[0] : c, l = i(n, 1) ? n[1] : void 0;
		...
		function(t, n, e) {
			...
			t.exports = function(t) {
				var n, e, s, l, p, h, v = o(t), g = "function" == typeof this ? this : Array, d = arguments.length, y = d > 1 ? arguments[1] : void 0, x = void 0 !== y, m = f(v), b = 0;
				if (x && (y = r(y, d > 2 ? arguments[2] : void 0, 2)), null == m || g == Array && a(m)) for (e = new g(n = u(v.length)); n > b; b++) h = x ? y(v[b], b) : v[b], c(e, b, h);
		...
		function(t, n, e) {
			...
			t.exports = function(t, n, e, s, h, x, m) {
				...
				}, O = n + " Iterator", R = !1, A = t.prototype, j = A[d] || A["@@iterator"] || h && A[h], I = !g && j || w(h), k = "Array" == n && A.entries || j;
		...
		function(t, n, e) {
			...
			[].keys && ("next" in (i = [].keys()) ? (o = a(a(i))) !== Object.prototype && (r = o) : p = !0), r ??= {}, s || c(r, l) || u(r, l, (function() {
				return this;
			})), t.exports = {
				IteratorPrototype: r,
		...
		function(t, n, e) {
			...
			a in u || o.f(u, a, { value: function(t) {
		...
		function(t, n, e) {
			...
			t.exports = function(t, n, e) {
				var g = -1 !== t.indexOf("Map"), d = -1 !== t.indexOf("Weak"), y = g ? "set" : "add", x = o[t], m = x && x.prototype, b = x, S = {}, E = function(t) {
					var n = m[t];
		...
		function(t, n, e) {
			...
			t.exports = {
				getConstructor: function(t, n, e, f) {
					...
					} }), l && r(s.prototype, "size", { get: function() {
						return h(this).size;
					} }), s;
				},
		...
		function(t, n, e) {
			var r = e(3), o = e(128).trim, i = e(129), a = r.parseFloat;
			t.exports = 1 / a(i + "-0") != -Infinity ? function(t) {
		...
		function(t, n, e) {
			...
			t.exports = 8 !== a(i + "08") || 22 !== a(i + "0x16") ? function(t, n) {
				var e = o(String(t));
		...
		function(t, n, e) {
				...
				if (!n.notified) {
					...
					R((function() {
						for (var o = n.value, i = 1 == n.state, a = 0; r.length > a;) {
							var u, c, f, s = r[a++], l = i ? s.ok : s.fail, p = s.resolve, h = s.reject, v = s.domain;
							try {
			...
			Y && (z = function(t) {
				...
				wrap: !0,
				forced: Y
			}, { Promise: z }), v(z, N, !1, !0), g(N), i = s(N), u({
				target: N,
				stat: !0,
				forced: Y
			}, { reject: function(t) {
		...
		function(t, n, e) {
			var r, o, i, a = e(3), u = e(6), c = e(11), f = e(64), s = e(61), l = e(17), p = e(177), h = a.location, v = a.setImmediate, g = a.clearImmediate, d = a.process, y = a.MessageChannel, x = a.Dispatch, m = 0, b = {}, S = function(t) {
		...
		function(t, n, e) {
			...
			o({
				...
				var n = String(c(this));
				u(t);
				var e = arguments.length > 1 ? arguments[1] : void 0, r = a(n.length), o = void 0 === e ? r : p(a(e), r), i = String(t);
		...
		function(t, n, e) {
			...
			r("split", 2, (function(t, n, e) {
				...
				return r = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, e) {
					...
					var l = i(t), p = String(this), h = u(l, RegExp), d = l.unicode, y = (l.ignoreCase ? "i" : "") + (l.multiline ? "m" : "") + (l.unicode ? "u" : "") + (g ? "y" : "g"), x = new h(g ? l : "^(?:" + l.source + ")", y), m = void 0 === o ? 4294967295 : o >>> 0;
					if (0 === m) return [];
		...
		function(t, n, e) {
			var r, o = e(3), i = e(126), a = e(120), u = e(119), c = e(239), f = e(14), s = e(25).enforce, l = e(26), p = !o.ActiveXObject && "ActiveXObject" in o, h = Object.isExtensible, v = function(t) {
				return function() {
					return t(this, arguments.length ? arguments[0] : void 0);
				};
		...
		function(t, n, e) {
			var r = e(126), o = e(120).getWeakData, i = e(20), a = e(14), u = e(123), c = e(122), f = e(63), s = e(15), l = e(25), p = l.set, h = l.getterFor, v = f.find, g = f.findIndex, d = 0, y = function(t) {
			...
			}, t.exports = { getConstructor: function(t, n, e, f) {
		...
		function(t, n, e) {
			...
			var r, o = e(2), i = e(5), a = e(244), u = e(3), c = e(59), f = e(21), s = e(123), l = e(15), p = e(147), h = e(79), v = e(197).codeAt, g = e(245), d = e(95), y = e(246), x = e(25), m = u.URL, b = y.URLSearchParams, S = y.getState, E = x.set, w = x.getterFor("URL"), O = Math.floor, R = Math.pow, A = /[A-Za-z]/, j = /[\d+-.A-Za-z]/, I = /\d/, k = /^(0x|0X)/, P = /^[0-7]+$/, L = /^\d+$/, T = /^[\dA-Fa-f]+$/, _ = /[\u0000\u0009\u000A\u000D #%/:?@[\\]]/, U = /[\u0000\u0009\u000A\u000D #/:?@[\\]]/, N = /^[\u0000-\u001F ]+|[\u0000-\u001F ]+$/g, C = /[\u0009\u000A\u000D]/g, F = function(t, n) {
			...
			}, tt = {}, nt = {}, et = {}, rt = {}, ot = {}, it = {}, at = {}, ut = {}, ct = {}, ft = {}, st = {}, lt = {}, pt = {}, ht = {}, vt = {}, gt = {}, dt = {}, yt = {}, xt = {}, mt = {}, bt = {}, St = function(t, n, e, o) {
				...
				for (e || (t.scheme = "", t.username = "", t.password = "", t.host = null, t.port = null, t.path = [], t.query = null, t.fragment = null, t.cannotBeABaseURL = !1, n = n.replace(N, "")), n = n.replace(C, ""), i = h(n); p <= i.length;) {
					switch (a = i[p], s) {
						...
						case mt:
							...
							break;
						case bt: a != r && (t.fragment += G(a, B));
					}
					p++;
				}
			}, Et = function(t) {
				var n, e, r = s(this, Et, "URL"), o = arguments.length > 1 ? arguments[1] : void 0, a = String(t), u = E(r, { type: "URL" });
				if (void 0 !== o) {
				...
				var t = w(this), n = t.scheme, e = t.username, r = t.password, o = t.host, i = t.port, a = t.path, u = t.query, c = t.fragment, f = n + ":";
		...
		function(t, n, e) {
			var r = /[^\0-\u007E]/, o = /[.\u3002\uFF0E\uFF61]/g, i = "Overflow: input needs wider integers to process", a = Math.floor, u = String.fromCharCode, c = function(t) {
				return t + 22 + 75 * (t < 26);
			}, f = function(t, n, e) {
				var r = 0;
		...
		function(t, n, e) {
			e(89);
			var r = e(2), o = e(34), i = e(244), a = e(21), u = e(126), c = e(95), f = e(91), s = e(25), l = e(123), p = e(15), h = e(64), v = e(84), g = e(20), d = e(14), y = e(58), x = e(8), m = e(247), b = e(83), S = e(49), E = o("fetch"), w = o("Headers"), O = S("iterator"), R = s.set, A = s.getterFor("URLSearchParams"), j = s.getterFor("URLSearchParamsIterator"), I = /\+/g, k = Array(4), P = function(t) {
...
(function(t) {
	...
	function c(t) {
		if (t.bodyUsed) return Promise.reject(/* @__PURE__ */ new TypeError("Already read"));
		t.bodyUsed = !0;
	}
	function p(t) {
	...
	function _(e, r) {
		return new Promise((function(n, i) {
			...
			a.onload = function() {
				...
				n(new E("response" in a ? a.response : a.responseText, r));
			}, a.onerror = function() {
				i(/* @__PURE__ */ new TypeError("Network request failed"));
...
//# sourceMappingURL=core-js-D1AjajDT.js.map