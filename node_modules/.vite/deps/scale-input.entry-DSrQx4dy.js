...
import { n as emitEvent, r as generateUniqueId } from "./utils-c4af5b47-5j7RUTeV.js";
//#region node_modules/@telekom/scale-components/dist/esm/scale-input.entry.js
...
var Input = class {
	...
	componentWillLoad() {
		if (this.inputId == null) this.inputId = "input-" + this.internalId;
		if (this.type === "select" && this.icon == null) this.icon = SELECT_ICON;
	}
	componentDidLoad() {
		statusNote({
			tag: "deprecated",
		...
		if (this.type === "select") {
			...
			if (this.value) select.value = String(this.value);
			else if (selectedValue) this.value = selectedValue;
		}
	...
	componentDidRender() {
		...
		if (this.type === "select" && this.controlled && this.selectElement.value.toString() !== value) this.selectElement.value = value;
	...
	render() {
		...
		if (this.type === "checkbox") return h(Host, { checked: this.checked }, h("div", { class: this.getCssClassMap() }, h("input", Object.assign({
			type: "checkbox",
			name: this.name,
			id: this.inputId,
		...
		}, h("span", { class: classnames("input__checkbox-placeholder") }), !!this.icon && this.checked && h("scale-icon", {
			path: this.icon,
			size: 12
		})), h("label", { htmlFor: this.inputId }, this.label), !!this.helperText && h("div", {
			class: "input__meta",
			id: helperTextId,
			"aria-live": "polite",
			"aria-relevant": "additions removals"
		}, h("div", { class: "input__helper-text" }, this.helperText))));
		if (this.type === "radio") return h(Host, null, h("div", { class: this.getCssClassMap() }, h("input", Object.assign({
			type: "radio",
			name: this.name,
			id: this.inputId,
			onChange: this.handleCheckChange,
			...
			checked: this.checked,
			disabled: this.disabled
		}, ariaInvalidAttr, ariaDescribedByAttr)), h("label", { htmlFor: this.inputId }, this.label), !!this.helperText && h("div", {
			class: "input__meta",
			id: helperTextId,
			"aria-live": "polite",
			"aria-relevant": "additions removals"
		}, h("div", { class: "input__helper-text" }, this.helperText))));
		return h(Host, null, h("div", { class: this.getCssClassMap() }, h("label", {
			class: "input__label",
			htmlFor: this.inputId
		}, this.label), this.type === "select" ? h("div", { class: "input__select-wrapper" }, h("select", Object.assign({
			...
			type: this.type,
			class: classnames(`input__${this.type === "textarea" ? "textarea" : "input"}`, this.customResize && this.customResize.id),
			...
			onBlur: this.handleBlur,
			onKeyDown: this.handleKeyDown
		}, !!this.placeholder ? { placeholder: this.placeholder } : {}, { disabled: this.disabled }, !!this.rows ? { rows: this.rows } : {}, !!this.cols ? { cols: this.cols } : {}, ariaInvalidAttr, ariaDescribedByAttr)), this.type === "textarea" && this.variant === "animated" && h("span", {
			...
			"aria-live": "polite",
			"aria-relevant": "additions removals"
		}, !!this.helperText && h("div", { class: "input__helper-text" }, this.helperText), this.counter && h("div", { class: "input__counter" }, !!this.value ? String(this.value).length : 0, " /", " ", this.maxLength))));
	}
	getCssClassMap() {
...
//#endregion
export { Input as scale_input };

//# sourceMappingURL=scale-input.entry-DSrQx4dy.js.map