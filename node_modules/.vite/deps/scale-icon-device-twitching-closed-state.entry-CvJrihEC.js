...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-device-twitching-closed-state.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var DeviceTwitchingClosedState = class {
	constructor(hostRef) {
...
//#endregion
export { DeviceTwitchingClosedState as scale_icon_device_twitching_closed_state };

//# sourceMappingURL=scale-icon-device-twitching-closed-state.entry-CvJrihEC.js.map