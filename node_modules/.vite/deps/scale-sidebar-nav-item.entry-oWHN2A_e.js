...
//#region node_modules/@telekom/scale-components/dist/esm/scale-sidebar-nav-item.entry.js
...
var SidebarNavItem = class {
	...
	componentDidLoad() {
		...
		if (this.current) this.syncActiveToCurrent(this.current);
	}
	/**
	...
	*/
	handleAriaCurrentInSlottedA(current) {
		...
		if (a != null) a.removeAttribute("aria-current");
...
//# sourceMappingURL=scale-sidebar-nav-item.entry-oWHN2A_e.js.map