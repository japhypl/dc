...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-communication-voice-message.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var CommunicationVoiceMessage = class {
	constructor(hostRef) {
...
//#endregion
export { CommunicationVoiceMessage as scale_icon_communication_voice_message };

//# sourceMappingURL=scale-icon-communication-voice-message.entry-DkUWqxyO.js.map