...
var TelekomFooterContent = class {
	...
	render() {
		return h(Host, null, h("footer", null, h("slot", { name: "extended-navigation" }), h("div", { part: "base" }, h("div", { part: "logo" }, h("scale-logo", {
			part: "app-logo",
			variant: "white",
			style: { "--focus-outline": "var(--telekom-line-weight-highlight) solid var(--telekom-color-functional-focus-on-dark-background)" },
			transparent: true,
			href: this.logoHref,
			logoHideTitle: this.logoHideTitle,
			logoTitle: this.logoHideTitle ? void 0 : this.logoTitle,
			focusable: this.logoHref ? true : false
		})), h("div", { part: "body" }, h("div", { part: "notice" }, h("slot", { name: "notice" })), h("div", { part: "navigation" }, h("slot", { name: "navigation" }))))));
	}
};
TelekomFooterContent.style = telekomFooterContentCss;
//#endregion
export { TelekomFooter as scale_telekom_footer, TelekomFooterContent as scale_telekom_footer_content };

//# sourceMappingURL=scale-telekom-footer_2.entry-D-kuyycF.js.map