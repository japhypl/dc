//#region node_modules/@telekom/scale-components/dist/esm/floating-ui.dom.esm-43ac86e1.js
var min = Math.min;
var max = Math.max;
...
function getOffsetParent(element, polyfill) {
	...
	while (offsetParent && isTableElement(offsetParent) && getComputedStyle(offsetParent).position === "static") offsetParent = getTrueOffsetParent(offsetParent, polyfill);
	if (offsetParent && (getNodeName(offsetParent) === "html" || getNodeName(offsetParent) === "body" && getComputedStyle(offsetParent).position === "static" && !isContainingBlock(offsetParent))) return window;
...
//#endregion
export { platform as a, offset as i, computePosition as n, shift as o, flip as r, arrow as t };

//# sourceMappingURL=floating-ui.dom.esm-43ac86e1-BRqXGRTG.js.map