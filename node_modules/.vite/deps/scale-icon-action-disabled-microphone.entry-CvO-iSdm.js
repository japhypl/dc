...
//#region node_modules/@telekom/scale-components/dist/esm/scale-icon-action-disabled-microphone.entry.js
var iconCss = "scale-icon{--display:inline-flex;--transition:all var(--telekom-motion-duration-transition)\n    var(--telekom-motion-easing-standard);display:var(--display)}scale-icon path{transition:var(--transition)}@media screen and (forced-colors: active), (-ms-high-contrast: active){scale-icon svg,.scale-icon{color:white;stroke:white}}";
var ActionDisabledMicrophone = class {
	constructor(hostRef) {
...
//#endregion
export { ActionDisabledMicrophone as scale_icon_action_disabled_microphone };

//# sourceMappingURL=scale-icon-action-disabled-microphone.entry-CvO-iSdm.js.map